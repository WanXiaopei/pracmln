...
project = "pracmln"
copyright = "%s, Daniel Nyga" % datetime.datetime.now().year
...
html_context = {
    "teaser_text": "We are happy to announce Version {} of pracmln!".format(version)
}
...
# of the sidebar.
html_logo = os.path.join("_static", "img", "pracmln-brightondark-transp.png")
...
man_pages = [("index", "mln_interface", "PRACMLN Documentation", ["Daniel Nyga"], 1)]
...
epub_title = "PRAC"
epub_author = "Daniel Nyga"
epub_publisher = "Daniel Nyga"
epub_copyright = "%s, Daniel Nyga" % datetime.datetime.now().year
